...
return [
    ...
    'kyc' => [
        'onboarding_title' => 'التحقق من الهوية',
        'onboarding_intro' => 'ارفع وثيقة هوية رسمية. التحقق يستخدم إعدادات KYC لهذه المساحة (الدولة، المستوى، محرك الاستخراج).',
        ...
        'confidence' => 'الثقة',
        'warnings' => 'تحذيرات',
        'queue_label' => 'المعالجة في الخلفية (طابور)',
        'submit' => 'تحقق من الوثيقة',
        'queued' => 'تمت إضافة الوثيقة لطابور التحقق. راجع لوحة المراجعة بعد قليل.',
        'result_title' => 'نتيجة التحقق',
        'verify_another' => 'تحقق من وثيقة أخرى',
        'open_review' => 'فتح لوحة المراجعة',
